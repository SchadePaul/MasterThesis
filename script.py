...
number = 1000
number2 = 50
cmd = subprocess.Popen(["../externalWork/SimPhy_1.0.2/bin/simphy_mac64", "-sl", "f:25", "-rs", str(number2), "-rl", "f:" + str(number), "-rg", "1", "-sb", "f:0.000000005", "-sd", "f:0", "-st", "ln:21.25,0.2", "-so", "f:1", "-si", "f:1", "-sp", "f:470000000", "-su", "ln:-21.9,0.1", "-hh", "f:1", "-hs", "ln:1.5,1", "-hl", "ln:1.551533,0.6931472", "-hg", "ln:1.5,1", "-cs", "9644", "-v", "3", "-o", name, "-ot", "0", "-op", "1", "-lb", "f:0.00000000049", "-ld", "f:0.00000000049", "-lt", "f:0"])
cmd.communicate()
d = 0
    ...
    for i in range(1, number + 1):
        ...
        while True:
            ...
            if not ignore:
                file.write(c)
    file.close()
    cmd2 = subprocess.Popen(["./njst/main", "-i", inputName + strr + str(j), "-o", outputName + strr + str(j)])
    cmd2.communicate()
