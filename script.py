...
legendNames = ["tagged", "tagged and rerooted", "miniNJ", "miniNJ weighted", "NJst"]
...
#            currentTime = int(round(time.time() * 1000))
        ...
        cmd2 = subprocess.Popen(["./njst/main", "-r", "-t", "-i", inputStr, "-o", outputStr + "1"])
        cmd2.communicate()

        cmd2 = subprocess.Popen(["./njst/main", "-m", "-i", inputStr, "-o", outputStr + "2"])
        cmd2.communicate()

        cmd2 = subprocess.Popen(["./njst/main", "-m", "-w", "-i", inputStr, "-o", outputStr + "3"])
        cmd2.communicate()

        cmd2 = subprocess.Popen(["./njst/main", "-i", inputStr, "-o", outputStr + "4"])
        cmd2.communicate()
...
for i in range(2):
    ...
    for j in range(len(numberOfLeaves)):
        fileResults.write(str(numberOfLeaves[j]) + "\T")
        for k in range(len(legendNames)):
